...
/**
 * Settings that control the behavior of WASP programs. Settings are stored in
 * Java property lists.
 * This class provides methods that allow easy access to the most basic
 * settings. Other task-specific,
 * model-specific and domain-specific settings can be obtained through the
 * <code>get</code> method. Keys
...
public class Config {
	...
	/**
	 * The property list that stores all key-value pairs specified in the
	 * configuration file.
	 */
	...
	/**
	 * Searches for the specified property in the current property list. This method
	 * returns
	...
	/**
	 * Returns the identifier of the current natural language. This is specified in
	 * the configuration
	...
	/**
	 * Returns the identifier of the current meaning-representation language. This
	 * is specified in the
	...
	/**
	 * Returns the current MRL grammar. The MRL grammar is read from the file
	 * specified in the
	...
	/**
	 * Returns the maximum number of top-scoring parses to return during testing.
	 * The actual number of
	 * parses returned can be more if there are ties. This number is specified in
	...
	/**
	 * Returns the type of the current NL language model. This is specified in the
	 * configuration file
	...
	/**
	 * Returns the type of the current translation model. This is specified in the
	...
	/**
	 * Returns the name of the directory in which the current translation model and
	 * language model are
	 * stored. This is specified in the configuration file via the key
	 * <code>wasp.model.dir</code>.
	 * 
	...
	/**
	 * Sets the name of the directory in which the current translation model and
	 * language model are
	...
	/**
	 * Returns the name of the file that contains the entire corpus. This corpus
	 * will be used for
	...
	/**
	 * The key to the current natural language. Recognized languages are:
	 * <code>en</code> for English,
	 * <code>es</code> for Spanish, <code>ja</code> for Japanese, and
	 * <code>tr</code> for Turkish.
	 */
	public static final String NL = "wasp.nl";

	/**
	 * The key to the current meaning-representation langauge. Recognized languages
	 * are:
	 * <code>geo-funql</code> for the functional query language in the Geoquery
	 * domain, and
	 * <code>robocup-clang</code> for CLang, the coach language in the RoboCup
	 * domain.
	 */
	public static final String MRL = "wasp.mrl";

	/**
	 * The key to the name of the file that contains the productions of the current
	 * MRL grammar.
	 */
	public static final String MRL_GRAMMAR = "wasp.mrl.grammar";

	/**
	 * The key to the maximum number of top-scoring parses to return during testing.
	 * The actual number
	...
	/**
	 * The key to the name of the directory in which the current translation model
	 * and language model
	 * are stored.
	 */
	...
	/**
	 * The key to the name of the file that contains the entire corpus for both
	 * training and testing.
	 */
	public static final String CORPUS_FILE = "wasp.corpus.file";

	/**
	 * The key to the current word alignment model. Recognized models are:
	 * <code>giza++</code> for the
	 * GIZA++ implementation of the IBM models, and <code>gold-standard</code> which
	 * uses the word
	...
	/**
	 * The key to the current translation model. The only recognized model is:
	 * <code>scfg</code> for
	...
	/**
	 * The key to the name of the file that contains the initial rules for training
	 * an SCFG.
	 */
	public static final String SCFG_INIT = "wasp.scfg.init";

	/**
	 * The key to the name of the file that contains the names of all geographical
	 * entities in the
	 * Geoquery domain.
	 */
	...
	/**
	 * The key to the name of the directory that contains the evaluation scripts for
	 * the Geoquery
	 * domain.
	 */
	...
	/**
	 * The key to the absolute pathname of the SICSTUS executable file, necessary
	 * for the Geoquery
	 * evaluation scripts.
	 */
	...
	/**
	 * Reads the specified configuration file and updates the current settings of
	 * WASP.
	 * 
	...
	/**
	 * Prints the settings stored in this <code>Config</code> object to the
