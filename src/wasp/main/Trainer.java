...
public class Trainer {
	...
	/**
	 * The main program for training translation models. This program takes the
	 ...
	 * <li><code><u>model-dir</u></code> - the directory for storing the learned
	 * translation model.</li>
	 * <li><code><u>mask-file</u></code> - the example mask that specifies the
	 * training set.</li>
	 * </ul>
	 * <p>
	 * Log messages are sent to the standard error stream, which can be captured for
	...
	public static void main(String[] args) throws IOException, SAXException, ParserConfigurationException {
		...
		// System.out.println(examples.get(0).id);
